...
const GtplRC128TableOfContents: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 font-['Inter',_Arial,_sans-serif]">
      {/* Back to Knowledge Base Button */}
      <div className="mb-6">
        <button 
          onClick={() => handleModuleChange('knowledge-base', 'Overview')}
          className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all ease-in-out"
        >
          <ArrowLeft size={16} />
      ...
      <div className="bg-gradient-to-r from-[#fdfbfb] to-[#ebedee] p-6 rounded-xl shadow-lg mb-8 text-center">
        <div className="flex justify-center mb-4">
          <Scale className="h-12 w-12 text-[#1d4ed8]" />
        </div>
        <h1 className="text-3xl font-bold text-gray-900">Government Tenders & Procurement Law (RC128) Guide</h1>
        <p className="text-lg text-gray-600 mt-2">Bilingual Legal Index | فهرس ثنائي اللغة لنظام المنافسات والمشتريات الحكومية</p>
        ...
        <div className="flex justify-center mt-4 space-x-4">
          <button
            ...
            } flex items-center gap-2 transition-all ease-in-out`}
          >
...
export default GtplRC128TableOfContents;